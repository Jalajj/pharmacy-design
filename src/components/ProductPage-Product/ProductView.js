...
const ProductView = () => {
  ...
  return (<div className={'productPageProduct'}>
    ...
    <div className={'flexWrapperOne-product'}><img alt="" className={'screenshot20220405At10061'} src="https://static.overlay-tech.com/assets/d0495add-9094-474c-b6c7-7d6963222568.png"/>
    </div></div>
   </div>);
};
